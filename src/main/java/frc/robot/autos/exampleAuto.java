...
public class exampleAuto extends SequentialCommandGroup {
    public exampleAuto(Swerve s_Swerve){
        ...
        // // This will load the file "Auto_Path.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
        // // for every path in the group
        // List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("Auto_Path", new PathConstraints(4, 3));
